...
def run(ctx: protocol_api.ProtocolContext):
    ...
    ctx.comment("Proteinase K: using {} strips with at least {:.2f} uL each".format(num_pk_strips, pk_cols_per_strip * PK_VOLUME * liquid_headroom))
