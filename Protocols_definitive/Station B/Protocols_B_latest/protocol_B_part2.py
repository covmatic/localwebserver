...
def run(ctx):
    ...
    update_log_file()
    # -------------------------------------------------------------------------
    current_status = 'Magnetic module still engaged'
    magdeck.engage(height=magheight)
    update_log_file()
    current_status = 'Wash B'
    ...
    current_status = 'magnetic module disengage'
    magdeck.disengage()
    update_log_file()
    ...
    current_status = 'Protocol B finished - Move to Station C'
    ctx.home()
    update_log_file()
